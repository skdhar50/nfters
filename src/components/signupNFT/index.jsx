    ...
    <div className="container py-[6.25rem]">
      <div className="grid grid-cols-2">
        <div className="flex justify-center items-center gap-[1.875rem]">
          <div className="flex flex-col justify-end items-end gap-[1.875rem]">
            <div className="relative">
              <img src={Image5} alt="" className="w-[18.75rem] h-[18.75rem]" />
              <img
                src={User1}
                alt=""
                className="w-[5rem] h-[5rem] absolute -bottom-[1.5625rem] -right-[1.5625rem] border-[0.3125rem] border-white rounded-full"
              />
            </div>
            <div className="relative">
              <img
                src={Image6}
                alt=""
                className="w-[12.1875rem] h-[13.375rem]"
              />
              <img
                src={User2}
                alt=""
          ...
          <div className="relative">
            <img
              src={Image7}
              alt=""
              className="w-[15.0625rem] h-[16.5625rem]"
            />
            <img
              src={User2}
              alt=""
        ...
        <div className="space-y-[1.5625rem] flex flex-col justify-center pl-[3.125rem]">
          <p className="uppercase text-[2rem] font-integral font-bold w-2/3">
            Create and sell your NFTs
          </p>
          <p className="text-[1.125rem] text-[#636363] w-2/3">
